...
const Form = () => { 
  ...
  const inputHandler = (e) => {
    ...
    setCertificateInfoUploaded({...certificateInfoUploaded, [changingProp]: changingValue})
    console.log(certificateInfo.date);
  }
  ...
  return (
      <div className='form-div'>
        <form className="form" onSubmit={saveAndDownloadHandler}>
            ...
            <input type="text" onChange={inputHandler} value={certificateInfoUploaded.name} name='name' id='name' placeholder='Enter name: '/>
            <label htmlFor="ins">Institution: </label>
            <input type="text" onChange={inputHandler} value={certificateInfoUploaded.ins} name='ins' id='ins' placeholder='Enter Institution name: '/>
            <label htmlFor="ach">Achievement: </label>
            <input type="text" onChange={inputHandler} value={certificateInfoUploaded.ach} name="ach" id="ach" placeholder='Enter the certificate purpose: ' />
            <label htmlFor="date">Date :</label>
            <input type="date" onChange={inputHandler} value={certificateInfoUploaded.date} name="date" id="date" />
            <label htmlFor="sign">Signature: </label>
            <h6>(Enter the signature of person who is issuing the certificate)</h6>
            <input type="text" onChange={inputHandler} value={certificateInfoUploaded.sign} name="sign" id="sign" placeholder='Enter authority signature:'/>
